...
object MimeUtils {
    private val mimeTypeToExtensionMap = hashMapOf<String, String>()
    private val extensionToMimeTypeMap = hashMapOf<String, String>()
    ...
    fun hasMimeType(mimeType: String): Boolean =
        guessExtensionFromMimeType(mimeType) != null
    ...
    fun guessMimeTypeFromExtension(extension: String?): String? =
        extension?.lowercase(Locale.US)?.let { extensionToMimeTypeMap[it] }
    ...
    fun guessExtensionFromMimeType(mimeType: String?): String? =
        mimeType?.lowercase(Locale.US)?.let { mimeTypeToExtensionMap[it] }
}
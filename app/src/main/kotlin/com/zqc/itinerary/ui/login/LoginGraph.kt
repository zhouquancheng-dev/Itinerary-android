...
import com.zqc.itinerary.ui.login.vm.UserViewModel
    ...
    navigation(
        ...
        enterTransition = {
            when (initialState.destination.route) {
                AppDestinations.StartScreen.route -> EnterTransition.None
                AppDestinations.WelcomeScreen.route -> EnterTransition.None
                HomePageDestinations.HomePage.route -> EnterTransition.None
                else -> slideIntoContainer(AnimatedContentTransitionScope.SlideDirection.Left)
            }
        },
        exitTransition = {
            when (targetState.destination.route) {
                AppDestinations.StartScreen.route -> ExitTransition.None
                AppDestinations.WelcomeScreen.route -> ExitTransition.None
                HomePageDestinations.HomePage.route -> ExitTransition.None
